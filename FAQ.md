...
Entelgia is currently a **Research Hybrid** project. While it has a stable codebase (v2.6.0) with comprehensive testing and CI/CD pipelines, it is primarily designed as an experimental platform for exploring consciousness-inspired AI architectures rather than a production service.
...
- Follow semantic versioning: Major.Minor.Patch (e.g., v2.6.0)
