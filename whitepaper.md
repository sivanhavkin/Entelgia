<div style="display: flex; align-items: center; justify-content: space-between;">
  ...
  <h1 style="flex-grow: 1; text-align: center; font-size: 2.5em; font-weight: bold; margin: 0;">🧠 Entelgia Whitepaper</h1>
...
where `w = Config.affective_emotion_weight` (default `0.4`). Memories with high emotional intensity surface first, matching how biologically plausible memory systems prioritize emotionally salient events.
