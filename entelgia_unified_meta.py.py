...
# -----------------------------
# LLM Wrapper (uses ollama Python SDK)
# -----------------------------
...
class Config:
    ...
    model_athena: str = "tinyllama:latest"
    model_fixy: str = "tinyllama:latest"
    ...
    stm_max_entries: int = 10_000     # your preference: supports up to 100k then starts deleting
    stm_trim_batch: int = 500        # how many to drop when exceeding
