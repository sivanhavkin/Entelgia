...
Generate your intervention (2-4 sentences, direct and concrete):"""
        ...
        return intervention.strip() if intervention else "I notice we might benefit from a fresh perspective here."
    
    def _build_intervention_context(self, dialog: List[Dict[str, str]], reason: str) -> str:
        """
    ...
    def _detect_high_conflict(self, turns: List[Dict[str, str]]) -> bool:
        ...
        conflict_markers = [
            'לא', 'אבל', 'disagree', 'however', 'wrong', 'incorrect',
            'actually', 'contrary', 'opposite', 'טעות', 'שגוי'
        ]
    ...
    def _detect_shallow_discussion(self, turns: List[Dict[str, str]]) -> bool:
        ...
        depth_markers = [
            'why', 'because', 'מדוע', 'כי', 'therefore', 'implies',
            'consequence', 'deeper', 'fundamental', 'underlying',
            'עמוק', 'יסוד', 'השלכה'
        ]
