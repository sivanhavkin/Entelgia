...
[![Tests](https://img.shields.io/badge/tests-80%20passed-brightgreen)](https://github.com/sivanhavkin/Entelgia/actions)
...
* **🆕 Energy-Based Regulation** (v2.5.0+)
  ...
  * **Dream cycles** — Automatic consolidation when energy falls below 35%
    * Forgetting phase: deletes old conscious LTM entries (keeps last `dream_keep_memories`, default 5)
...
> ✅ **All 80 tests currently pass** (16 energy regulation + 33 long-term memory + 19 security + 5 dialogue + 6 enhanced dialogue + 1 conftest), providing confidence that the new personal memory architecture, cryptographic memory-security mechanisms, and enhanced dialogue system all perform as expected.
...
> ✅ **All 24 of these tests pass** (5 dialogue + 19 security). See the Long-Term Memory and Energy Regulation sections for the 56 additional tests.
...
|----------|-------|---------|
| **Unit Tests** | `pytest` | Runs 80 total tests (16 energy + 33 long-term memory + 19 security + 5 dialogue + 6 enhanced dialogue + 1 conftest) |
