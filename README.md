...
* 📖  [Entelgia Demo](https://github.com/sivanhavkin/Entelgia/blob/main/entelgia_demo.md)- See the system in action
...
|---------|--------|-------|
| **v3.4.0** | ✅ **Stable** | Latest release |
| **v2.3.0** | ⚠️ Superseded | Use v3.4.0 instead |
| **v2.2.0** | ⚠️ Superseded | Use v3.4.0 instead |
| **v2.1.1** | ⚠️ Superseded | Use v3.4.0 instead |
| v2.1.0 | ⚠️ Superseded | Use v3.4.0 instead |
| v2.0.01 | ⚠️ Superseded | Use v3.4.0 instead |
...
- **Minor** (v3.4.0): New features, backward compatible  
